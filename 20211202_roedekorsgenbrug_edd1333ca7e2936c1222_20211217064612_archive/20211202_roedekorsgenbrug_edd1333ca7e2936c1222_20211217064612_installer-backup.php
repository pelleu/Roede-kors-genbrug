...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211202_roedekorsgenbrug_edd1333ca7e2936c1222_20211217064612_archive.zip';
	const ARCHIVE_SIZE		 = '177599606';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'edd1333-17064612';
    const SECONDARY_PACKAGE_HASH = '678010a-17064612';
	const VERSION			 = '1.4.3';
